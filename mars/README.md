...
An educational R package implementing the Multivariate Adaptive Regression
Splines (MARS) algorithm.
...
This package implements a compact MARS workflow with:
...
The package currently includes the main components of the MARS algorithm:
...
This is an educational implementation intended to illustrate the main logic
of MARS clearly rather than reproduce every optimization used in production
packages.
